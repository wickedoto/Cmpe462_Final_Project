...
if exist('rawSensorData_train.mat','file') && exist('rawSensorData_test.mat','file')
    ...
    trainActivity = categorical(importdata('Data/UCI HAR Dataset/train/y_train.txt'),1:6,activity_labels);
    ...
    filestoload = strcat('Data/UCI HAR Dataset/train/Inertial Signals/',{'*gyro*','total*'});
    ...
    testActivity = categorical(importdata('Data/UCI HAR Dataset/test/y_test.txt'),1:6,activity_labels);
    ...
    filestoload = strcat('Data/UCI HAR Dataset/test/Inertial Signals/',{'*gyro*','total*'});
	% Choose this if you want to load all files
